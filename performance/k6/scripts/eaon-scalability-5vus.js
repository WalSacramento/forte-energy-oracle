...
// Test configuration - Scalability test with 5 VUs
export const options = {
  scenarios: {
    scalability_5vus: {
      executor: 'shared-iterations',
      vus: 5,
      iterations: 30,  // Total de 30 iterações distribuídas entre 5 VUs
...
export function setup() {
  ...
  console.log('  EAON k6 Scalability Test - 5 VUs');
  console.log('  Target: 30 iterations with 5 VUs');
...
export function teardown(data) {
  console.log('\n' + '='.repeat(70));
  console.log('  Scalability test (5 VUs) completed successfully');
  console.log('='.repeat(70));
}
...
export function handleSummary(data) {
  ...
  return {
    ...
    'results/local/k6/scalability-5vus-results.json': JSON.stringify(data, null, 2),
    'results/local/k6/scalability-5vus-table.txt': generateTaxonomyTable(data),
    'results/local/k6/scalability-5vus-report.html': htmlReport(data)
  };
}
