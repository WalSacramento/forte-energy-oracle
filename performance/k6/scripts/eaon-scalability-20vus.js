...
// Test configuration - Scalability test with 20 VUs
export const options = {
  scenarios: {
    scalability_20vus: {
      executor: 'shared-iterations',
      vus: 20,
      iterations: 30,  // Total de 30 iterações distribuídas entre 20 VUs
...
export function setup() {
  ...
  console.log('  EAON k6 Scalability Test - 20 VUs');
  console.log('  Target: 30 iterations with 20 VUs');
...
export function teardown(data) {
  console.log('\n' + '='.repeat(70));
  console.log('  Scalability test (20 VUs) completed successfully');
  console.log('='.repeat(70));
}
...
export function handleSummary(data) {
  ...
  return {
    ...
    'results/local/k6/scalability-20vus-results.json': JSON.stringify(data, null, 2),
    'results/local/k6/scalability-20vus-table.txt': generateTaxonomyTable(data),
    'results/local/k6/scalability-20vus-report.html': htmlReport(data)
  };
}
